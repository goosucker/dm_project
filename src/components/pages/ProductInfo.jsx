...
export const ProductInfo = () => {
    ...
    const cartProduct = useSelector(state => state.cart.find(product => product.id === id));
    ...
    const getProduct = async () => {
        try {
            const res = await axios.get(BASED_URL + `/products/${id}`, {
                    ...
                    <div>
                        ...
                        {seeProductCounter 
                            ...
                            <div style={{display: "flex"}}>
                                ...
                                /> 
                                <button className={offerBtnStyle}>Оформить заказ</button>
                            </div>
                            : 
                            <button 
